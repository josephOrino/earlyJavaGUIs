...
public class Main extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Please enter PIN and click proceed to"); // NOI18N
        ...
        jLabel2.setText("continue."); // NOI18N
    ...
    private void proceedActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_proceedActionPerformed
        ...
        if (!temp.equals("022002")){
            count--;
            if (count >0 && count <= 3){
                JOptionPane.showMessageDialog(null, "Please Try Again. " + count + " tries left.");
                pass.setText("");
            } else if (count == 0){
                JOptionPane.showMessageDialog(null, "Sorry. It seems you forgot the password.");
                System.exit(0);
            }
        } else if (temp.equals("022002")){
            JOptionPane.showMessageDialog(null, "Hello Joseph!");
            go.show();
            dispose();
        }
